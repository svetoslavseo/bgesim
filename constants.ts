...
export const COUNTRIES: Country[] = [
    ...
    { id: 'th', name: 'Thailand', flag: '🇹🇭', flagUrl: '/esim-data/flags/thailand.svg', regionId: 'asia', slug: countryNameToSlug('Thailand'), countryCode: 'TH', plans: [] },
    { id: 'my', name: 'Malaysia', flag: '🇲🇾', flagUrl: '/esim-data/flags/malaysia.svg', regionId: 'asia', slug: countryNameToSlug('Malaysia'), countryCode: 'MY', plans: [] },
    ...
    { id: 'in', name: 'India', flag: '🇮🇳', flagUrl: '/esim-data/flags/india.svg', regionId: 'asia', slug: countryNameToSlug('India'), countryCode: 'IN', plans: [] },
    { id: 'nl', name: 'Netherlands', flag: '🇳🇱', flagUrl: '/esim-data/flags/netherlands.svg', regionId: 'europe', slug: countryNameToSlug('Netherlands'), countryCode: 'NL', plans: [] },
    { id: 'kr', name: 'South Korea', flag: '🇰🇷', flagUrl: '/esim-data/flags/skorea.svg', regionId: 'asia', slug: countryNameToSlug('South Korea'), countryCode: 'KR', plans: [] },
    { id: 'sg', name: 'Singapore', flag: '🇸🇬', flagUrl: '/esim-data/flags/singapore.svg', regionId: 'asia', slug: countryNameToSlug('Singapore'), countryCode: 'SG', plans: [] },
    ...
    { id: 'mx', name: 'Mexico', flag: '🇲🇽', flagUrl: '/esim-data/flags/mexico.svg', regionId: 'north-america', slug: countryNameToSlug('Mexico'), countryCode: 'MX', plans: [] },
